...
> [!danger] 如果你使用windows，务必查看[5 配置ClaudeCode可用的Git Bash环境](../../AI/Claude%20Code/5%20配置ClaudeCode可用的Git%20Bash环境.md)，在添加hooks到你的ClaudeCode之后你必须使用git bash启动ClaudeCode
