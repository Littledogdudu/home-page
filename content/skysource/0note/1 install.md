...
> [!warning] 如果你发现无法安装或安装后启动ClaudeCode出现avx指令不支持的错误，使用[2.2.1 指定版本安装](#2.2.1%20指定版本安装)
...
> [!warning] 这种方法仅适用于使用 [1 使用npm安装（全平台）](#1%20使用npm安装（全平台）) 时使用
...
> [!warning] 这种方法仅适用于使用 [2 使用终端原生安装](#2%20使用终端原生安装) 时使用
